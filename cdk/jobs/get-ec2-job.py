...
account = '042724325311' # hardcoded for simplicity, some account with an ec2 instance and installed assumed role
role = 'co-dfghje' # The role installed in customer's inventory
